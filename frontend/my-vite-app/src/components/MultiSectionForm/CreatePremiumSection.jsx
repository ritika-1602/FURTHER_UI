...
const CreatePremiumSection = ({ clientData, productData, initialData, onBack, onCancel, onContinue }) => {
    ...
    <div className="premium-form-wrapper">
      ...
      <div className="premium-container">
        ...
        <div className="currency-row">
          ...
          <button className="btn small" onClick={handleAddRow}>Add row</button>
          <button className="btn small" onClick={handleRemoveRow}>Remove row</button>
        </div>
